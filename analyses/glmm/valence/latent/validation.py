...
figpath = paths.figures / "glmm" / "valence" / "latent" / "validation"
...
fig.savefig(figpath / f"{target}-latent-trace.pdf")
...
fig.savefig(figpath / f"{target}-latent-ess.pdf")
...
fig.savefig(figpath / f"{target}-latent-autocorr.pdf")
...
fig.savefig(figpath / f"{target}-latent-ppc.pdf")
...
fig.supxlabel(target.capitalize(), y=-0.03)
fig.supylabel("Density", x=-0.02)
fig.savefig(figpath / f"{target}-latent-ppc-by-country.pdf")
...
fig.tight_layout()
fig.savefig(figpath / f"{target}-latent-ppc-by-country-political.pdf")
...
fig.tight_layout()
fig.savefig(figpath / f"{target}-latent-bpv.pdf")
